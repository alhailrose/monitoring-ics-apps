...
- [ ] Add normalized `finding_events` schema and migration
- [ ] Add mappers for `guardduty`, `cloudwatch`, `notifications`
- [ ] Persist normalized findings from API runs
- [ ] Add query endpoint for findings (filter/pagination)
- [ ] Add API contract examples for findings
- [ ] Mark phase as done in this plan
