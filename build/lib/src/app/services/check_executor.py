...
class CheckExecutor:
    ...
    def execute(
        ...
        raw_results = self._execute_parallel(accounts, checks_to_run)
    ...
    def _execute_parallel(self, accounts: list, checks: dict) -> dict:
            ...
            for account in accounts:
                for chk_name, _checker_class in checks.items():
                    ...
                    if account.config_extra and chk_name in account.config_extra:
                        check_kwargs = account.config_extra[chk_name]
